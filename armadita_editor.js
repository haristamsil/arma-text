...
function updateFormatButtons() {
  ...
  formatButtons.forEach(button => {
    ...
    if (selection.anchorNode.parentNode.tagName === "A" && button === linkBtn) {
...
boldBtn.addEventListener("click", () => {editor.focus();document.execCommand("bold", false, null)});
underlineBtn.addEventListener("click", () => {editor.focus();document.execCommand("underline", false, null)});
italicBtn.addEventListener("click", () => {editor.focus();document.execCommand("italic", false, null)});
...
h2Btn.addEventListener("click", () => {editor.focus();document.execCommand("formatBlock", false, "<h2>")});
h3Btn.addEventListener("click", () => {editor.focus();document.execCommand("formatBlock", false, "<h3>")});
pBtn.addEventListener("click", () => {editor.focus();document.execCommand("formatBlock", false, "<p>")});
imgBtn.addEventListener("click", () => {
  ...
  if (url) {
    ...
    } else if (url.includes('pexels.com') || url.includes('pixabay.com') || url.includes('unsplash.com')) {
...
editor.addEventListener("input", () => {
  ...
  this.dispatchEvent(new CustomEvent("textChange", { detail: textArea.value }));
});
